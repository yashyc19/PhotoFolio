...
const jwt = require('backend/utils/jwt'); // Custom JWT authentication middleware
const errorHandler = require('backend/utils/error_handler'); // Custom error handling middleware
...
// Routes
app.use('/', require('backend/routes/admin.controller')); // Uses the admin routes
